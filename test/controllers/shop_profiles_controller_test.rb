...
class ShopProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shop_profile" do
    assert_difference('ShopProfile.count') do
      post shop_profiles_url, params: { shop_profile: { about: @shop_profile.about, business_name: @shop_profile.business_name, contact_number: @shop_profile.contact_number, location: @shop_profile.location, user_id: @shop_profile.user_id } }
    end
  ...
  test "should update shop_profile" do
    patch shop_profile_url(@shop_profile), params: { shop_profile: { about: @shop_profile.about, business_name: @shop_profile.business_name, contact_number: @shop_profile.contact_number, location: @shop_profile.location, user_id: @shop_profile.user_id } }
